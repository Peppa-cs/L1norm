 ...
 */
// This class is used to calibrate precision from fp32 to int8
...
public:
    ...
    const void* readCalibrationCache(size_t& length)
    {
        ...
        std::ifstream input("/home/peppa1/CalibrationTable/"+mCalibrationTableName);
        input >> std::noskipws;
    ...
    {
        std::ofstream output("/home/peppa1/CalibrationTable/"+mCalibrationTableName);
